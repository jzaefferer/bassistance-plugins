...
var xslTransform = {
	...
	transform: function( xsl, xml, options ){
		...
		if( Sarissa.getParseErrorText(result.doc) != Sarissa.PARSED_OK ){
...
jQuery.fn.getTransform = function( xsl, xml, options ){
	...
	return this.each( function(){
		...
		$(this)[ this.type ? "val" : "html" ]( trans.string );
		...
		if( settings.callback && settings.callback.constructor == Function ){
